package com.tanuj.Spring.Boot.scheduler;
...
import com.tanuj.Spring.Boot.repository.UserRepositoryImplementation;
import com.tanuj.Spring.Boot.service.EmailService;
import com.tanuj.Spring.Boot.service.SentimentAnalysisService;
...
//    @Scheduled(cron = "0 0 9 ? * SUN *")
    public void fetchUsersAndSendSaMail(){
        List<User> users = userRepositoryImplementation.getUserForSA();
        for(User user:users){
